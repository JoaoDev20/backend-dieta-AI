/* 
 ...
 USER PROMPT - INFORMAÇÕES PARA IA
...
export function buildSystemPrompt(){
   return [
    ...
    Regras fixas:
    - Sempre responda em texto markdown légivel para humanos.
    ...
    - Não responda em JSON ou outor formato, apeas texto markdown legível para humanos.
